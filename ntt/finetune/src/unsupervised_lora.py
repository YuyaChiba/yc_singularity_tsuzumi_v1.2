...
def main(args):
    ...
    #train_dataset = load_dataset("text", data_files={"train": [train_filename]})
    train_dataset = load_dataset("json", data_files={"train": [train_filename]}, cache_dir=args.cache_dir)
    ...
    trainer = Trainer(
        ...
        args=training_args,
        train_dataset=tokenized_dataset.with_format("torch")["train"],
    )
